...
\title{Typografie a publikovaní\\{\large 1. projekt}}
\author{Sabína Gregušová\\xgregu02@stud.fit.vutbr.cz}
\date{}
\maketitle
...
\begin{quotation}
Čím více { \fontfamily{cmtt}\selectfont druhů}, \textbf{\textit{řezů}}, velikostí, barev písma a { \fontfamily{cmss}\selectfont jiných efektů} použijeme, tím \textit{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy \textbf{{ \huge nadšen!}}
\end{quotation}
...
Důležitým znakem správně vysázeného dokumentu je konzistence -- například \textbf{tučný řez} písma bude vyhradzen pouze pro klíčová slova, \emph{skloněný řez} pouze pro doposud neznámé pojmy a nebude se to míchat. Skloněný řez nepůsobí tak rušivě a používá se častěji. V \LaTeX u jej sázíme raději příkazem{ \fontfamily{cmtt}\selectfont \textbackslash emph\{text\}} než { \fontfamily{cmtt}\selectfont \textbackslash textit\{text\}.}
...
Druhou odlišností je pravidlo pro sázení konců řádků. V české sazbě by řádek neměl končit osamocenou jednopísmennou předložkou nebo spojkou. Spojkou \uv{a} končit může pouze při sazbě do šířky 25 liter. Abychom \LaTeX u zabránili v sázení osamocených předložek, spojujeme je s následujícím slovem \textit{nezlomitelnou mezerou.} Tu sázíme pomocí znaku { \fontfamily{cmtt}\selectfont \char`\~} (vlnka, tilda). Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnote{Viz \url{http://petr.olsak.net/ftp/olsak/vlna}}.

Balíček{ \fontfamily{cmtt}\selectfont  fontenc} slouží ke korektnímu kódovaní znaků s diakritikou, aby bylo možno v textu vyhledávat a kopírovat z nej.


\section{Závěr}

Tento dokument schválně obsahuje několik typografických prohřešků. Sekce \ref{smisena_sazba} a \ref{rady} obsahují typografické chyby. V kontextu celého textu je jistě snadno najdete. Je dobré znát možnosti \LaTeX u, ale je také nutné vědět, kdy je nepoužít.
